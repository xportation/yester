...
NÃO fazer commit da versão lite. Ou seja, se vc rodar o script para versão lite, não fazer o commit. Isso não é regra, é uma convenção. Afinal vc pode desenvolver com a Lite só usando as configuraçõs de build no Xamarin Studio.
