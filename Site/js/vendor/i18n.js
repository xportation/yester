/*http://kirox.de/util/J42R/test.html*/
    ...
    load: function() {
        ...
        $.getJSON('i18n/'+lang,function(data) {
            self.put(lang,data).t();
                ...
                // if doesnt have the language fallback to default
                self.lang = self.defaultLang;
                $.getJSON('i18n/'+self.lang,function(data) {
                    self.put(self.lang,data).t();
                }).error(function(){
                        self.put(self.lang,{}).t();
                    });
            });
        return this;
    },
